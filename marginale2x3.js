...
function onGameEnded() {
    var lastGame = engine.history.first()
        ...
        {
            if (currentRound < config.start2After.value || (currentRound > config.start2After.value && lastGame.cashedAt == 3)) {
...
{
    return (amount / 3) + config.baseBet.value;
}
