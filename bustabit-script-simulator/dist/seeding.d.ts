 ...
 */
export declare const TERMINATING_HASH = "567a98370fb7545137ddb53687723cf0b8a1f5e93b1f76f4a1da29416930fa59";
/**
 * VX's BLS public key used for signature verification.
 */
export declare const VX_PUBKEY = "b40c94495f6e6e73619aeb54ec2fc84c5333f7a88ace82923946fc5b6c8635b08f9130888dd96e1749a1d5aab00020e4";
/**
 * Maximum number of games in the hash chain.
 */
export declare const MAX_GAME_ID = 100000000;
/**
 ...
 * ```
 */
export declare function verifyInChain(hash: Uint8Array): number | null;
/**
 ...
 * ```
 */
export declare function validateSignature(gameSalt: string, prevGameHash: Uint8Array, vxSignature: Uint8Array): boolean;
/**
 ...
 * ```
 */
export declare function gameResult(vxSignature: Uint8Array, gameHash: Uint8Array): number;
