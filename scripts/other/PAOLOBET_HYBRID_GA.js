...
var config = {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    sessionStopLoss: {
        value: 17,  // v5.0: 15% → v5.1: 20% (più spazio per recovery)
        type: 'multiplier',
    ...
    // ═══════════════════════════════════════════════════════════════════════
    partialTP1Target: {
        value: 9,  // v5.0: 15% → v5.1: 10% (lock più veloce)
        type: 'multiplier',
    ...
    // ═══════════════════════════════════════════════════════════════════════
    mode1Step1Mult: {
        value: 3.83,  // v4.2: 3.5x | v5.0: 4.0x | v5.1: 3.75x (compromesso)
        type: 'multiplier',
        label: '[Modo1] Step 1 moltiplicatore (3.75x v5.1)'
    },
    mode1Step2Mult: {
        value: 10.81,  // v4.2: 10.0x | v5.0: 12.0x | v5.1: 11.0x (compromesso)
        type: 'multiplier',
    ...
    // ═══════════════════════════════════════════════════════════════════════
    mode2Target: {
        value: 3.90,  // v4.2: 3.5x | v5.0: 4.0x | v5.1: 3.75x (compromesso)
        type: 'multiplier',
